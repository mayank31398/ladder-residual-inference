...
transformer_configs = {
    ...
    "1b": dict(
        ...
        vocab_size=49152,
        rope_base=10000,
        reduce_pattern=[{"attention": False, "mlp": False} for _ in range(40)],
    ...
    "70B-infinite-semi-compiled": dict(
        n_layer=80,
        n_head=64,
        dim=8192,
        n_local_heads=8,
    ...
    "llama-3-8b-4x": dict(
        ...
        vocab_size=128256,
        rope_base=500000,
        reduce_pattern=[{"attention": False, "mlp": False}, {"attention": False, "mlp": True}] * 16,
    ),
    "llama-3-8b-upper-bound": dict(
        block_size=8192,
        n_layer=32,
        n_head=32,
        n_local_heads=8,
        ...
        vocab_size=128256,
        rope_base=500000,
        reduce_pattern=[{"attention": False, "mlp": False} for _ in range(32)],
        force_disable_last_all_reduce=True,
    ),
    "llama-3-8b-infinite": dict(
        block_size=8192,
        n_layer=32,
        n_head=32,
        n_local_heads=8,
    ...
    "llama-3-70b-4x": dict(
        ...
        vocab_size=128256,
        rope_base=500000,
        reduce_pattern=[{"attention": False, "mlp": False}, {"attention": False, "mlp": True}] * 40,
    ),
    "llama-3-70b": dict(
        block_size=8192,
        n_layer=80,
    ...
    "llama-3.1-405b-upper-bound": dict(
        ...
        vocab_size=128256,
        rope_base=500000,
        reduce_pattern=[{"attention": False, "mlp": False} for _ in range(126)],
        force_disable_last_all_reduce=True,
        rope_scaling=dict(
            factor=8.0, low_freq_factor=1.0, high_freq_factor=4.0, original_max_position_embeddings=8192
        ),
