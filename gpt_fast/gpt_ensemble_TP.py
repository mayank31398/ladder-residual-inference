...
transformer_configs = {
    ...
    "1b": dict(block_size=2048, n_layer=40, n_head=24, n_local_heads=24, dim=1536, intermediate_size=4096, vocab_size=49152, rope_base=10000,reduce_pattern=[{"attention": False, "mlp": False} for _ in range(40)], force_disable_last_all_reduce=True),
    "1b-upper-bound": dict(block_size=2048, n_layer=40, n_head=24, n_local_heads=24, dim=1536, intermediate_size=4096, vocab_size=49152, rope_base=10000),
    ...
    "3b-upper-bound": dict(block_size=2048, n_layer=40, n_head=36, n_local_heads=36, dim=2304, intermediate_size=9216, vocab_size=49152, rope_base=10000, reduce_pattern=[{"attention": False, "mlp": False} for _ in range(40)], force_disable_last_all_reduce=True),
    ...
    "llama-3-8b-2x": dict(block_size=8192, n_layer=32, n_head=32, n_local_heads=8, dim=4096, intermediate_size=14336, vocab_size=128256, rope_base=500000, reduce_pattern=[{"attention": False, "mlp": False}, {"attention": False, "mlp": True}] * 16),
    ...
    "llama-3-70b-2x": dict(block_size=8192, n_layer=80, n_head=64, n_local_heads=8, dim=8192, intermediate_size=28672, vocab_size=128256, rope_base=500000, reduce_pattern=[{"attention": False, "mlp": False}, {"attention": False, "mlp": True}] * 40),
