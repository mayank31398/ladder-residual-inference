...
transformer_configs = {
    ...
    "1b": dict(block_size=2048, n_layer=40, n_head=24, n_local_heads=8, dim=1536, intermediate_size=4096, vocab_size=49152, rope_base=10000,reduce_pattern=[{"attention": False, "mlp": False} for _ in range(40)], force_disable_last_all_reduce=True),
    "1b-upper-bound": dict(block_size=2048, n_layer=40, n_head=24, n_local_heads=8, dim=1536, intermediate_size=4096, vocab_size=49152, rope_base=10000),
    "3b": dict(block_size=2048, n_layer=40, n_head=36, n_local_heads=8, dim=2304, intermediate_size=9216, vocab_size=49152, rope_base=10000),
    "3b-upper-bound": dict(block_size=2048, n_layer=40, n_head=36, n_local_heads=8, dim=2304, intermediate_size=9216, vocab_size=49152, rope_base=10000, reduce_pattern=[{"attention": False, "mlp": False} for _ in range(40)], force_disable_last_all_reduce=True),
