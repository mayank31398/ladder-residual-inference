...
do
    ...
    for model_name in "gpt_dense:llama-3.1-405b" # "gpt_ensemble:llama-3.1-405b-upper-bound" # "gpt_parallel:llama-3.1-405b"
    do
        ...
        do
            ...
            do
                ...
                NCCL_NVLS_ENABLE=1 NCCL_P2P_DISABLE=${P2P_DISABLE} torchrun --nproc_per_node=8 --nnodes=${nodenum} --master_addr=${master_address} --master_port=15318 --node_rank=$1 benchmark.py \
                                                ...
                                                --compile \
                                                --compile_prefill \
                                                --device cuda 2>&1 | tee ${folder}/bs_${bssize}_tp_${tpsize}_pp_${ppsize}_node_$1.log
